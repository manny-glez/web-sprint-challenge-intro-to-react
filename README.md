...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  ...
  answer: React helps make code more reusable via the component paradigm, and provides a better way to handle complex state and  makes code more modular.

2. Describe component state.

  answer: Components state is a way to manage an application's data.

3. Describe props.

  answer: Props are objects that are passed down from parent components to child components.

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

  answer: Side effects are being able to effect something outside of a function.
